...
class StockTradeViewModel : ViewModel() {
    ...
    private var allRows = emptyList<StockTrade>()
    private var keyword = ""
    ...
    private val _stockList = MutableLiveData<List<StockTrade>>(emptyList())
    val stockList: LiveData<List<StockTrade>> = _stockList
