...
class StockAverageViewModel : ViewModel() {
    private val repository by lazy { StockRepository() }
    private val disposables = CompositeDisposable()
    private var loaded = false
    private var allRows = emptyList<StockAverage>()
    private var keyword = ""
    ...
    private val _stockList = MutableLiveData<List<StockAverage>>(emptyList())
    val stockList: LiveData<List<StockAverage>> = _stockList
