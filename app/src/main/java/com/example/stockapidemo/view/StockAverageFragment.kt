...
import com.example.stockapidemo.adapter.StockAverageAdapter
import com.example.stockapidemo.databinding.FragmentStockAverageBinding
import com.example.stockapidemo.viewmodel.StockAverageViewModel

class StockAverageFragment : Fragment() {
    private var _binding: FragmentStockAverageBinding? = null
    private val viewModel: StockAverageViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        return FragmentStockAverageBinding.inflate(inflater, container, false).also {
            _binding = it
        }.root
    }
    ...
    private fun initView() {
        ...
        binding.columns.apply {
            ...
            monthlyAveragePrice.setText(R.string.monthly_average_price)
            listOf(code, name, closingPrice, monthlyAveragePrice).forEach {
                it.setTypeface(null, Typeface.BOLD)
            }
        }
        binding.recyclerView.layoutManager = LinearLayoutManager(requireContext())
        binding.recyclerView.adapter = StockAverageAdapter().apply {
    ...
    private fun observeData() {
        val binding = requireNotNull(_binding)
        val adapter = binding.recyclerView.adapter as StockAverageAdapter
